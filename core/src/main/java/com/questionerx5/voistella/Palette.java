...
public class Palette{
    ...
    WHITE = DescriptiveColorRgb.describe("#ffffff"),

    RED = DescriptiveColorRgb.describe("#ff0000"),
    ...
    SKY = DescriptiveColorRgb.describe("#3fbfff"),
    BLUE = DescriptiveColorRgb.describe("#0000ff"),
    MAGENTA = DescriptiveColorRgb.describe("#ff00ff");
}
